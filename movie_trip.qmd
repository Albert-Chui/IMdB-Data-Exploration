...
```{r, echo = F}
ggplot() + 
  geom_line(data = adult_movies, aes(x=startYear, y = avg_rating, group =1), color = "red") +
  geom_line(data = not_adult_movies, aes(x=startYear, y = avg_rating1, group =1), color = "blue") + 
  scale_x_discrete(breaks = seq(0, max(timed_genre_ratings$startYear), by = 25)) + 
